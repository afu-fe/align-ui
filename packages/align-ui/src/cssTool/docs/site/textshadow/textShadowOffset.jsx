...
const Index = () => {
  const arr = {
    ...
    'test-shadow-offset-number': { textShadowOffset: { width: 'number', height: 'number' } },
    ...
    'test-shadow-offset-normal': { textShadowOffset: { width: 24, height: 24 } },
    'test-shadow-offset-relaxed': { textShadowOffset: { width: 26, height: 26 } },
    'test-shadow-offset-loose': { textShadowOffset: { width: 32, height: 32 } },
    'test-shadow-offset-[333]': { textShadowOffset: { width: 333, height: 333 } },
    'test-shadow-offset-[23]/[33]': { textShadowOffset: { width: 23, height: 33 } },
  };
  return (
