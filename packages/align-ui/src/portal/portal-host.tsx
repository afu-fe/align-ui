...
// events
const addType = 'REACT_NATIVE_ALIGN_UI_ADD_PORTAL'
const removeType = 'REACT_NATIVE_ALIGN_UI_REMOVE_PORTAL'
...
export default class PortalHost extends Component<PortalHostProps> {
  ...
  addTypeEmitter: EmitterSubscription | null = null;
  removeTypeEmitter: EmitterSubscription | null = null;
  componentDidMount() {
  ...
  componentWillUnmount() {
    if (this.addTypeEmitter && this.addTypeEmitter.remove) {
    ...
    if (this.removeTypeEmitter && this.removeTypeEmitter.remove) {
