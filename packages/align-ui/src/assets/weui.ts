...
export const CIRCLE: IconItem = {
  ...
  defaultColor: '#C9C9C9',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/circle.png',
};
export const DOWNLOAD: IconItem = {
  ...
  defaultColor: '#09BB07',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/download.png',
};
export const INFO: IconItem = {
  ...
  defaultColor: '#10AEFF',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/info.png',
};
export const SAFE_SUCCESS: IconItem = {
  ...
  defaultColor: '#09BB07',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/safe_success.png',
};
export const SAFE_WARN: IconItem = {
  ...
  defaultColor: '#FFBE00',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/safe_warn.png',
};
export const SUCCESS: IconItem = {
  ...
  defaultColor: '#09BB07',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/success.png',
};
export const SUCCESS_CIRCLE: IconItem = {
  ...
  defaultColor: '#09BB07',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/success_circle.png',
};
export const SUCCESS_NO_CIRCLE: IconItem = {
  ...
  defaultColor: '#09BB07',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/success_no_circle.png',
};
export const WAITING: IconItem = {
  ...
  defaultColor: '#10AEFF',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/waiting.png',
};
export const WAITING_CIRCLE: IconItem = {
  ...
  defaultColor: '#10AEFF',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/waiting_circle.png',
};
export const WARN: IconItem = {
  ...
  defaultColor: '#F43530',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/warn.png',
};
export const INFO_CIRCLE: IconItem = {
  ...
  defaultColor: '#10AEFF',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/info_circle.png',
};
export const CANCEL: IconItem = {
  ...
  defaultColor: '#F43530',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/cancel.png',
};
export const SEARCH: IconItem = {
  ...
  defaultColor: '#B2B2B2',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/search.png',
};
export const CLEAR: IconItem = {
  ...
  defaultColor: '#B2B2B2',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/clear.png',
};
export const BACK: IconItem = {
  ...
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/back.png',
};
export const DELETE: IconItem = {
  ...
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/delete.png',
};

export const ADJUST: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/adjust.png',
};
export const BLACK_RIGHT_SHIFT: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/blackRightShift.png',
};
export const CLOSE: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/close.png',
};
export const EXPLAIN_LINEAR: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/explain_linear.png',
};
export const EXPLAIN_PLANE: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/explain_plane.png',
};

export const FALL: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/fall.png',
};

export const FEEDS_CLOSE: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/feeds_close.png',
};

export const FOLD: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/fold.png',
};
export const GROUP: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/group.png',
};

export const HOOK: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/hook.png',
};

export const FIRE: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/fire.png',
};

export const LANDSCAPE: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/landscape.png',
};

export const MODULE_LOADING: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/module_loading.png',
};

export const MORE_BLUE: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/more_blue.png',
};

export const MORE_GRAY: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/more_gray.png',
};

export const MORE: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/more.png',
};

export const PDF: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/pdf.png',
};

export const PIN: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/pin.png',
};
export const PLANE: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/plane.png',
};

export const POPUPUNFOLD: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/popupunfold.png',
};

export const QUOTATION_WAITING: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/quotation_waiting.png',
};

export const RADIO_JUMP: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/radio_jump.png',
};

export const RIGHTSHIFT: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/rightshift.png',
};

export const RISE: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/rise.png',
};

export const SAFETY: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/safety.png',
};

export const SELL_DISABLED: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/sell_disabled.png',
};
export const SELL: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/sell.png',
};

export const SHARE: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/share.png',
};

export const TRADE_DETAIL: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/trade_detail.png',
};

export const TRADE_DINGTOU_DISABLED: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/trade_dingtou_disabled.png',
};

export const TRADE_DINGTOU: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/trade_dingtou.png',
};

export const TRADE_Hide: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/trade_hide.png',
};

export const TRADE_TRADINGRECORD: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/trade_tradingrecord.png',
};

export const TRADE_VISIBLE: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/trade_visible.png',
};

export const UNFOLD: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/unfold.png',
};

export const WHITEHOOK: IconItem = {
  defaultColor: '',
  image: 'https://z.autoimg.cn/sou/auto-ui/icon/whiteHook.png',
};
