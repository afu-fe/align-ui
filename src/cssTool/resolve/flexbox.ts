...
const flexBoxConfig: FlexBoxConfig = {
  '1': 1,
  none: 'none',
  // 添加其他配置项
};
...
export function alignContent(value: string, style: Record<string, any>): Record<string, any> {
...
export function alignItems(value: string, style: Record<string, any>): Record<string, any> {
...
export function alignSelf(value: string, style: Record<string, any>): Record<string, any> {
...
export function justifyContent(value: string, style: Record<string, any>): Record<string, any> {
...
export function justifyItems(value: string, style: Record<string, any>): Record<string, any> {
...
export function justifySelf(value: string, style: Record<string, any>): Record<string, any> {
...
export function flexBasis(value: string, style: Record<string, any>): Record<string, any> {
  const configSize = flexBasisConfig?.[value]; // 是否为固定变量
  if (configSize !== undefined) {
    style[`flexBasis`] = configSize;
  }
  let v = parseInt(value); // flex属性拓展
  if (Number.isFinite(v)) {
    style[`flexBasis`] = 4 * v;
