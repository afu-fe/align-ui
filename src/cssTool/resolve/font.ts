...
export function fontverticalAlign(value: string, style: Record<string, any>): Record<string, any> {
  if (['baseline', 'top', 'middle', 'bottom', 'text-top', 'text-bottom'].includes(value)) {
...
export function textAlignVertical(value: string, style: Record<string, any>): Record<string, any> {
...
export function textDecorationLine(value: string, style: Record<string, any>): Record<string, any> {
...
export function fontVariant(value: string, style: Record<string, any>): Record<string, any> {
...
export function fontFamily(value: string, style: Record<string, any>): Record<string, any> {
...
export function fontStyle(value: string, style: Record<string, any>): Record<string, any> {
  switch (value) {
    case 'italic':
    ...
    case 'backface-hidden':
      style.backfaceVisibility = value === 'backface-visible' ? 'visible' : 'hidden';
      break;
  }
...
export function writingDirection(value: string, style: Record<string, any>): Record<string, any> {
...
export function textTransform(value: string, style: Record<string, any>): Record<string, any> {
  switch (value) {
    case 'uppercase':
    case 'lowercase':
    case 'capitalize':
...
export function lineHeight(value: string, style: Record<string, any>): Record<string, any> {
